...
export default async (tweet: any) => {
  ...
  const tweetData: Tweet = {
    ...
    content: tweet.extended_tweet ? tweet.extended_tweet.full_text : tweet.text,
    quoted: tweet.is_quote_status ? {
      tweetId: tweet.quoted_status.id_str,
      content: tweet.quoted_status_extended_tweet ? tweet.quoted_status_extended_tweet.full_text : tweet.quoted_status_text,
